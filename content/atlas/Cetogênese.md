...
Cetose fisiológica pode ocorrer em jejum, restrição de carboidrato, exercício prolongado e recém-nascidos. Cetoacidose diabética, alcoólica e por jejum prolongado são estados patológicos com acidose, cetonas e alterações hemodinâmicas que exigem manejo específico.

Presença de cetonas na urina ou no sangue não distingue cetose adaptativa de cetoacidose. Glicemia, pH, bicarbonato, beta-hidroxibutirato, sintomas e causa determinam a interpretação.
...
Cetose não implica automaticamente perda de gordura, melhora de diabetes ou segurança metabólica. O estado ácido-base e o desfecho clínico são diferentes de uma concentração de cetona.

Dietas cetogênicas produzem respostas heterogêneas e podem exigir monitoramento em diabetes, gestação, doença renal, hepática ou uso de inibidores de SGLT2. Evidência de um protocolo não deve ser aplicada a todos os cenários.
