...
Colecistocinina é um hormônio peptídico secretado por células I do duodeno e jejuno após nutrientes, principalmente gordura e produtos da digestão proteica. Isoformas diferentes atuam em receptores CCK1 e CCK2, com funções digestivas e neurais.
...
CCK é um sinal de saciedade de curta duração, não um determinante único do peso corporal. Concentração plasmática não mede atividade vagal ou receptores no tecido.

Resultados com injeção de CCK em laboratório podem exagerar a exposição fisiológica de uma refeição. Mecanismo de retardo gástrico não permite concluir que estimular CCK trate obesidade ou melhore desfechos clínicos.
...
- NCBI Bookshelf. *Physiology, Gallbladder*. https://www.ncbi.nlm.nih.gov/books/NBK482488/
