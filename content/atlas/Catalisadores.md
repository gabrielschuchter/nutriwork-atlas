...
Catalisadores são substâncias que aumentam a velocidade de uma reação ao oferecer um caminho com menor energia de ativação, sem serem consumidos de forma líquida no processo.

Catalisadores não tornam uma reação termodinamicamente favorável nem alteram a constante de equilíbrio. Eles aceleram tanto a reação direta quanto a reversa, permitindo que o equilíbrio seja alcançado mais rapidamente.
