...
Prematuridade refere-se ao nascimento ocorrido antes de 37 semanas completas de gestação.
...
Além disso, imaturidade gastrointestinal, neurológica e metabólica pode limitar a ingestão e utilização dos nutrientes.

O [[Leite materno]] é considerado a alimentação de escolha, embora frequentemente necessite de fortificação para atender às elevadas demandas nutricionais dos prematuros.
...
Muitas recomendações derivam de desfechos intermediários e não necessariamente de resultados clínicos de longo prazo.
...
- WHO Recommendations for Preterm Infants.
