...
O DMG é uma das complicações metabólicas mais frequentes da gravidez.
...
Persistem divergências internacionais sobre critérios diagnósticos e pontos de corte laboratoriais.

Pequenas alterações nos critérios podem produzir grandes diferenças na prevalência da condição.

Também existe debate sobre a melhor composição dietética para o manejo do DMG.

Embora o controle glicêmico seja um objetivo importante, muitas intervenções são avaliadas principalmente por desfechos substitutos, dificultando a comparação entre estratégias alimentares.
...
- WHO Diagnostic Criteria for Hyperglycaemia in Pregnancy.

- Cochrane Reviews sobre manejo nutricional do DMG.
