...
O amido digerível contribui para a glicemia e para a oferta de energia. Alimentos amiláceos podem ter respostas pós-prandiais distintas: farinha refinada, batata cozida, leguminosa inteira e produto resfriado não são equivalentes. Em diabetes, o planejamento deve considerar porção, preparo e distribuição do carboidrato.

Amido resistente pode alcançar o cólon e ser fermentado. Isso pode modificar consistência das fezes, produção de [[Ácidos graxos de cadeia curta (AGCC)]] e saciedade, embora o efeito sintomático varie. A introdução rápida de grandes quantidades pode piorar distensão em pessoas sensíveis.
