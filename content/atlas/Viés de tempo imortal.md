...
O mecanismo é puramente epidemiológico. Considere um estudo em que pacientes são classificados como "usuários" de determinado suplemento apenas após iniciá-lo durante o seguimento. Para pertencer ao grupo exposto, o indivíduo necessariamente precisa sobreviver até o momento da exposição. O período entre a entrada no estudo e o início do suplemento torna-se um intervalo "imortal", pois o participante não poderia ter apresentado o desfecho e ainda assim permanecer elegível para o grupo exposto. Quando esse tempo é analisado incorretamente, ocorre distorção sistemática das estimativas.
