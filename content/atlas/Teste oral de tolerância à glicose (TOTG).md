...
Na obstetrícia, o TOTG tem papel central na identificação do [[Diabetes mellitus gestacional|diabetes mellitus gestacional]] e na estratificação de risco materno-fetal.
...
Um exemplo importante é o estudo HAPO (Hyperglycemia and Adverse Pregnancy Outcome), que demonstrou associação entre níveis crescentes de glicemia materna e risco aumentado de alguns desfechos adversos, mesmo abaixo dos valores previamente utilizados para diagnóstico de diabetes.

Entretanto, essa relação é contínua: não existe uma separação natural absoluta entre “normal” e “doença”. Os pontos de corte diagnósticos são escolhas clínicas baseadas no equilíbrio entre benefícios, riscos, recursos disponíveis e impacto das intervenções.

## Limitações e controvérsias

O TOTG apresenta algumas limitações importantes.

Dependência de critérios diagnósticos
...
A ampliação dos critérios diagnósticos aumenta a identificação de casos leves. Isso pode trazer benefícios, mas também aumenta intervenções, monitoramento e impacto psicológico.

A questão central não é apenas “detectar mais alterações”, mas determinar quais diagnósticos adicionais levam a benefícios clínicos relevantes que superem custos e potenciais danos.
