...
DAGs representam relações causais assumidas e ajudam a identificar confundidores, mediadores e colisores. Bradford Hill propôs considerações como temporalidade, consistência, gradiente e plausibilidade para julgar evidência, sem transformar a lista em teste necessário ou suficiente.

Mecanismo bioquímico pode apoiar plausibilidade. A inferência precisa seguir dado → estimativa → controle de vieses → evidência convergente → efeito clínico. Biomarcador alterado é resultado intermediário até demonstrar relação com desfecho centrado no paciente.
