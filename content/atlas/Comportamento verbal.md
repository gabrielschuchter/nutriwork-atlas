...
O comportamento verbal ocupa posição central na prática clínica em [[Nutrição|nutrição]], pois grande parte das intervenções depende da interação verbal entre profissional e paciente.

Exemplos incluem:

- relatar o consumo alimentar;

- solicitar orientação;

- fazer perguntas;

- negociar metas terapêuticas;

- descrever sintomas;

- expressar dificuldades de adesão;

- interpretar recomendações nutricionais.
...
No [[Behaviorismo radical|behaviorismo radical]], o comportamento verbal é compreendido como um produto da [[Ontogênese]], desenvolvido por meio da interação do indivíduo com sua comunidade verbal.

Ao contrário de abordagens que explicam a linguagem principalmente por estruturas mentais ou competências inatas, Skinner propôs que diferentes formas de comportamento verbal podem ser classificadas segundo as contingências responsáveis por sua emissão.

Entre os principais operantes verbais descritos em Verbal Behavior estão:

- mando, controlado principalmente por [[Operações motivadoras]] e reforçado por consequências específicas;

- tato, controlado por estímulos do ambiente e reforçado socialmente;

- ecoico, controlado por estímulos verbais com correspondência formal;

- intraverbal, controlado por outros estímulos verbais sem correspondência ponto a ponto;

- textual e transcrição, relacionados aos comportamentos de leitura e escrita.

Essa classificação não depende da forma da resposta. Uma mesma frase pode desempenhar funções diferentes dependendo das contingências presentes.

Por exemplo, "Estou com fome" pode funcionar como um mando, quando emitida para obter alimento, ou como um tato, quando descreve um estado corporal diante de uma pergunta clínica.

## Limitações e controvérsias

A interpretação skinneriana da linguagem permanece uma das áreas mais debatidas da psicologia.

Uma das críticas históricas mais influentes foi apresentada por Noam Chomsky, que argumentou que processos de aprendizagem seriam insuficientes para explicar a produtividade e a complexidade da linguagem humana. Essa crítica contribuiu para o desenvolvimento das abordagens cognitivistas e da linguística gerativa.

Por outro lado, pesquisadores da [[Análise do comportamento|Análise do Comportamento]] argumentam que muitas críticas dirigidas a Verbal Behavior decorreram de diferenças filosóficas sobre o objetivo da explicação científica, e não apenas de divergências empíricas. Desenvolvimentos posteriores da área, como pesquisas sobre equivalência de estímulos e teoria das molduras relacionais (Relational Frame Theory), ampliaram a investigação comportamental da linguagem, embora nem todas essas abordagens sejam consensuais dentro da própria tradição analítico-comportamental.
