...
Os termos cofator, coenzima e grupo prostético são relacionados, porém não intercambiáveis. O uso comercial de “cofator” para atribuir benefícios amplos a suplementos não substitui demonstração de deficiência, dose adequada e desfecho clínico.

Concentrações plasmáticas podem não refletir a disponibilidade intracelular. Doses acima da necessidade podem causar toxicidade, interações ou desequilíbrio entre minerais. A plausibilidade de uma função enzimática não basta para indicar suplementação.
...
- National Institutes of Health, Office of Dietary Supplements. [Vitamin and Mineral Supplement Fact Sheets](https://ods.od.nih.gov/factsheets/list-VitaminsMinerals/). Accessed September 2026.
