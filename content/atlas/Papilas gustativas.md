...
Papilas gustativas são estruturas da língua que contêm botões gustativos ou participam da organização da superfície lingual. Os botões abrigam células receptoras capazes de detectar qualidades gustativas e transmitir sinais para o sistema nervoso.

Papilas filiformes, fungiformes, foliadas e circunvaladas não têm a mesma densidade nem a mesma função. As filiformes têm papel mecânico e, em geral, não contêm botões gustativos.
...
Receptores gustativos identificam doce, salgado, azedo, amargo e umami por mecanismos moleculares distintos. Sinais são conduzidos por nervos cranianos até o tronco encefálico, tálamo e áreas corticais, onde se integram com olfato, recompensa, memória e estado fisiológico.

O paladar contribui para detecção de nutrientes e substâncias potencialmente nocivas. A resposta observada em um teste sensorial depende de exposição, contexto e aprendizagem, portanto não representa apenas a sensibilidade periférica da língua.
