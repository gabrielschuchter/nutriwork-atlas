...
A via é indispensável em eritrócitos, que não possuem mitocôndrias, e ganha participação relativa em tecidos com elevada demanda energética, limitação de oxigênio ou alta taxa proliferativa.

Durante exercício intenso, o aumento do fluxo glicolítico pode superar a capacidade de oxidação mitocondrial do piruvato, favorecendo a formação de lactato. Isso não significa que o músculo tenha se tornado completamente anaeróbico.

Alterações em enzimas glicolíticas podem causar anemias hemolíticas ou miopatias metabólicas. Na oncologia, o aumento da glicólise mesmo com oxigênio disponível integra o chamado [[Efeito Warburg]], mas não representa uma característica exclusiva de células malignas: células normais em proliferação rápida, como linfócitos ativados, apresentam padrão metabólico semelhante (Vander Heiden et al., 2009; Sun et al., 2019).
...
- Sun H, Chen L, Cao S, Liang Y, Xu Y. Warburg effects in cancer and normal proliferating cells: two tales of the same name. Genomics Proteomics Bioinformatics. 2019;17(3):273-86. https://doi.org/10.1016/j.gpb.2018.12.006
