...
A ingestão proteica sustenta manutenção de massa magra, cicatrização, imunidade e síntese de proteínas funcionais. Necessidades aumentam em crescimento, gestação, lactação, envelhecimento, doença aguda e exercício, com magnitude dependente da condição. Desnutrição pode ocorrer com peso estável quando a oferta ou utilização proteica é insuficiente.

Avaliação clínica deve integrar ingestão, perda de peso, função, composição corporal, inflamação, doença renal e tolerância alimentar. Albumina sérica é influenciada por inflamação e distribuição de fluidos e não funciona como medida isolada de ingestão proteica.
...
- NCBI Bookshelf. *Physiology, Proteins*. https://www.ncbi.nlm.nih.gov/books/NBK555990/
