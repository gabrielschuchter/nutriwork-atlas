...
Ferramentas de risco de viés não são escalas de qualidade global nem substituem julgamento. “Ajustado por muitas variáveis” não garante controle adequado e pode introduzir [[Colisor (Collider Bias)]].

Viés de publicação, seleção de desfecho e relato seletivo podem afetar revisões. A ausência de descrição em um artigo gera preocupação ou incerteza; não permite afirmar que o viés ocorreu.
