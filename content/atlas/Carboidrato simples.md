...
Açúcares livres em bebidas, doces e produtos de alta densidade energética podem facilitar excesso calórico e cárie quando consumidos com frequência. Frutas, leite e preparações culinárias também contêm açúcares simples acompanhados por água, proteína, gordura, fibra ou micronutrientes. A fonte e a matriz mudam a exposição fisiológica.

Na orientação de pessoas com diabetes ou hipertrigliceridemia, o foco pode incluir bebidas açucaradas, porções e substituições concretas. Retirar todos os alimentos classificados como “simples” pode eliminar opções adequadas e dificultar adesão.
...
“Simples” frequentemente é usado como sinônimo de “refinado”, “açucarado” ou “ruim”, produzindo confusão entre estrutura, processamento e qualidade dietética. Mel, suco e fruta inteira podem conter açúcares semelhantes em composição e muito diferentes em matriz e velocidade de consumo.

Estudos que comparam dietas precisam especificar o que foi substituído. Reduzir açúcar pode melhorar o desfecho porque diminui energia total, modifica bebidas ou aumenta alimentos in natura; o mecanismo exato depende do desenho e da intervenção.
