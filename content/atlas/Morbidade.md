...
Morbidade descreve a ocorrência, a presença ou a carga de doença e suas consequências em indivíduos ou populações. Pode ser representada por incidência, prevalência, sintomas, complicações, incapacidade, hospitalização ou medidas de qualidade de vida. O indicador deve especificar doença, definição e período.
...
Incidência conta eventos novos entre pessoas em risco; prevalência inclui casos existentes e depende de incidência e duração. Hospitalização e uso de serviço refletem doença, acesso, prática clínica e limiar de admissão.

Uma intervenção pode alterar sintomas, incapacidade e mortalidade por mecanismos diferentes. A análise precisa seguir do dado ao estimador, à incerteza e à inferência, distinguindo [[Mortalidade]] de desfechos substitutos.
