...
Cegamento, ou mascaramento, é a restrição de informação sobre a intervenção atribuída para participantes, profissionais, avaliadores ou analistas. O objetivo é reduzir mudanças de comportamento, cointervenções, mensuração diferencial e decisões influenciadas pela expectativa.
...
Perguntar ao participante qual intervenção recebeu não mede sozinho a qualidade do cegamento. Um mascaramento que falha pode ainda preservar alguma proteção se o desfecho for objetivo.

Ensaios abertos podem ser adequados quando a intervenção é complexa ou o cegamento impraticável. A transparência sobre a limitação é mais informativa que o rótulo “cego”.
