...
A caquexia é observada com frequência em pacientes com câncer avançado, insuficiência cardíaca, doença pulmonar obstrutiva crônica, doença renal crônica e outras condições inflamatórias persistentes. Seu reconhecimento influencia prognóstico, planejamento terapêutico, indicação de suporte nutricional e definição de objetivos de cuidado. Em muitos casos, a progressão da síndrome está associada a redução da tolerância a tratamentos e pior qualidade de vida.

## Base fisiológica ou epidemiológica

A fisiopatologia envolve interação entre inflamação sistêmica, alterações neuroendócrinas, aumento do [[Catabolismo|catabolismo]] proteico e modificações no [[Metabolismo|metabolismo]] energético. Citocinas inflamatórias como TNF-α, IL-1 e IL-6 participam de mecanismos que favorecem degradação muscular e alterações do apetite. Evidências sugerem participação adicional de alterações mitocondriais, ativação do sistema ubiquitina-proteassoma e remodelação metabólica induzida pela doença de base. Diferentemente do jejum simples, a perda muscular tende a persistir mesmo quando há aumento da oferta energética.
...
- Muscaritoli M, Anker SD, Argilés J, et al. Consensus Definition of Cachexia.
- Arends J et al. ESPEN Practical Guideline: Clinical Nutrition in Cancer.
