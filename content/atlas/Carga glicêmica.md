...
A carga glicêmica é utilizada principalmente em:

- pesquisa epidemiológica;

- aconselhamento nutricional para [[Diabetes mellitus tipo 2]];
...
A carga glicêmica apresenta limitações importantes quando utilizada isoladamente.

Ela não considera fatores como processamento dos alimentos, matriz alimentar, teor de fibras, composição da refeição, velocidade de ingestão, atividade física e variabilidade glicêmica individual.

Além disso, alimentos com baixa carga glicêmica não são necessariamente saudáveis, assim como alimentos com carga glicêmica relativamente elevada podem integrar padrões alimentares de alta qualidade nutricional.

Na prática clínica, a carga glicêmica deve complementar, e não substituir, a avaliação global da alimentação.
...
- Brouns F, et al. Recomendações metodológicas sobre índice glicêmico e carga glicêmica.
