...
A relação entre [[ATP]], [[ADP]] e AMP é descrita pelo conceito de [[Carga energética celular]]. Quando ADP se acumula, a adenilato quinase pode produzir ATP e AMP. O AMP pode então modular enzimas alostéricas e ativar sistemas de sinalização energética.

O AMP também integra o [[Metabolismo|metabolismo]] de purinas e pode ser desaminado a IMP.

## Limitações e controvérsias

AMP, razão AMP/[[ATP]] e ativação de AMPK não são intercambiáveis. A atividade da AMPK também depende de fosforilação, localização celular, isoformas e sinais como cálcio.

Resultados mecanísticos envolvendo AMPK podem sustentar plausibilidade biológica, mas não demonstram automaticamente melhora de peso, controle glicêmico, desempenho ou prognóstico clínico.
