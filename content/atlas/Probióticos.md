...
Probióticos são microrganismos vivos que, quando administrados em quantidades adequadas, conferem benefício à saúde do hospedeiro. A definição exige identificar o microrganismo e demonstrar benefício para a situação de uso.

Alimento fermentado ou produto que contém bactérias vivas não é automaticamente probiótico. Efeito de uma cepa não pode ser transferido sem evidência para outra espécie, mistura ou dose.
...
Possíveis mecanismos incluem competição por nicho, produção de metabólitos, modulação de barreira e interação imune. Esses mecanismos podem coexistir, mas sua demonstração in vitro não comprova melhora clínica.

Ensaios randomizados observam efeitos que variam entre cepas e desfechos. Meta-análise de produtos heterogêneos pode produzir uma média sem aplicação clara a uma formulação específica.
