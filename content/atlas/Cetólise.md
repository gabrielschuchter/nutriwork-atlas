...
Concentração de corpos cetônicos não mede a taxa de cetólise. Aumento de uso pode coexistir com produção ainda maior e cetose circulante elevada.

Melhora de utilização de cetonas em um estudo de exercício ou dieta não demonstra ganho de desempenho, perda de peso ou proteção neurológica. Cada inferência depende do desfecho clínico medido.
