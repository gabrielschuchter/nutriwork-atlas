...
Sarcopenia é uma doença muscular esquelética caracterizada por redução progressiva de força muscular associada à diminuição de quantidade e/ou qualidade muscular. Segundo o consenso do grupo europeu European Working Group on Sarcopenia in Older People, a baixa força muscular constitui o principal critério para identificação inicial do quadro, enquanto alterações de massa muscular confirmam o diagnóstico e comprometimento funcional indica gravidade. Outros consensos internacionais apresentam pequenas diferenças nos pontos de corte e métodos diagnósticos.
...
A fisiopatologia envolve interação entre envelhecimento biológico, [[Resistência anabólica|resistência anabólica]] muscular, alterações hormonais, redução da atividade física, inflamação sistêmica de baixo grau e ingestão proteica insuficiente em determinados contextos. A perda de unidades motoras, alterações neuromusculares e redução da capacidade de síntese proteica contribuem para o declínio funcional. Evidências sugerem que a força muscular declina mais rapidamente que a massa muscular, razão pela qual consensos recentes passaram a priorizar medidas de força na definição diagnóstica.
...
- Asian Working Group for Sarcopenia. Asian Working Group for Sarcopenia: 2019 Consensus Update.
- ESPEN guideline on clinical nutrition and hydration in geriatrics.
- Cruz-Jentoft AJ, Sayer AA. Sarcopenia. Lancet. 2019.
- Cuppari L. Nutrição Clínica no Adulto. Edições recentes.
