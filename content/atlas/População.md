...
População é o conjunto de unidades sobre o qual uma pergunta científica pretende descrever ou estimar um efeito. Pode ser população-alvo, população-fonte, população elegível ou população efetivamente analisada. A definição inclui tempo, local, critérios e desfecho.
