...
Teste de interação avalia se o efeito de uma exposição ou tratamento varia conforme o nível de uma segunda variável. Em um modelo, um termo de interação representa a diferença entre efeitos condicionais. O teste responde à hipótese de homogeneidade do efeito sob o modelo especificado.
...
Teste de interação costuma ter menos poder que teste do efeito global. P acima do limiar mantém compatíveis várias diferenças entre efeitos. P baixo informa incompatibilidade com a hipótese de homogeneidade sob o modelo, sem estabelecer relevância clínica ou mecanismo.

Muitos subgrupos aumentam falsos positivos. Pré-especificação, poucas hipóteses, replicação e consistência entre escalas fortalecem a interpretação.
