...
Intervalo de confiança é um intervalo calculado por um procedimento estatístico que, sob repetição do método e validade de suas suposições, cobriria o parâmetro verdadeiro na proporção indicada. Um intervalo de 95% descreve o desempenho do procedimento, não uma probabilidade posterior do parâmetro neste estudo.
