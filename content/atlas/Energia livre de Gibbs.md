...
Energia livre de Gibbs é a função termodinâmica (G = H - TS), em que (H) é a entalpia, (T) a temperatura absoluta e (S) a entropia. Em temperatura e pressão constantes, a variação de (G) ajuda a avaliar a tendência termodinâmica de uma transformação.

Uma reação com ΔG negativo é termodinamicamente favorável na direção considerada; ΔG positivo indica necessidade de acoplamento a uma reação favorável; ΔG igual a zero caracteriza equilíbrio. A grandeza informa termodinâmica, não a velocidade da reação.
