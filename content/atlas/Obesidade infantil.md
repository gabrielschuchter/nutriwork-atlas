...
A obesidade infantil é uma condição caracterizada pelo acúmulo excessivo de tecido adiposo em crianças e adolescentes, associado a maior probabilidade de alterações metabólicas, funcionais e psicossociais.

A definição clínica em pediatria geralmente utiliza indicadores antropométricos ajustados para idade e sexo, principalmente o [[Índice de massa corporal (IMC) para idade]], interpretado por meio de curvas de crescimento e [[Escore Z de crescimento infantil]].
...
A obesidade infantil é relevante na prática clínica porque está associada a maior probabilidade de alterações presentes na infância e persistência do excesso de adiposidade ao longo da vida.
...
Em algumas crianças, especialmente as mais jovens, pode ser adequado reduzir a velocidade de ganho ponderal enquanto ocorre crescimento linear, permitindo melhora progressiva do IMC.

## Base fisiológica, bioquímica ou epidemiológica

O desenvolvimento da obesidade infantil resulta de interação complexa entre regulação energética, biologia individual e ambiente.

O tecido adiposo não é apenas um depósito energético; ele funciona como órgão metabolicamente ativo, produzindo adipocinas e mediadores inflamatórios que participam da regulação do [[Metabolismo|metabolismo]].
...
A prevalência de obesidade infantil aumentou em diversas populações nas últimas décadas, tornando-se um problema relevante de saúde pública.

Estudos populacionais associam obesidade na infância e adolescência a maior risco de obesidade adulta e doenças crônicas. Entretanto, a trajetória individual é variável: nem toda criança com obesidade manterá o mesmo grau de adiposidade na vida adulta, e intervenções podem modificar essa trajetória.

## Limitações e controvérsias

A principal limitação do diagnóstico baseado em IMC é que ele é uma medida indireta de adiposidade.
...
Outro ponto crítico é evitar abordagens que aumentem estigma corporal. O estigma relacionado ao peso está associado a sofrimento psicológico, pior relação com alimentação e pode dificultar procura por cuidado.

A evidência sustenta que intervenções familiares e multicomponentes podem melhorar alguns indicadores de saúde, mas os efeitos geralmente são modestos e variáveis. Não existe uma intervenção única capaz de resolver a obesidade infantil em todos os contextos.
