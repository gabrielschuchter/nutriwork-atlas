...
Digestão de uma refeição e turnover de proteína muscular são processos relacionados, não equivalentes. Aumento de um marcador de proteólise em músculo não quantifica a degradação de todo o corpo.

Suplementos enzimáticos podem modificar sintomas em condições definidas, como insuficiência pancreática, mas a resposta não se extrapola para pessoas sem diagnóstico. Estudos mecanísticos não definem indicação clínica universal.
