...
Redução do apetite pode ser desejável em tratamento da obesidade e indesejável em câncer, doença crítica, depressão, demência ou desnutrição. Um fármaco anorexígeno exige indicação, contraindicações, interação medicamentosa e monitoramento de peso, função e ingestão.

A anorexia clínica é sintoma que precisa de causa investigada. Nomear um sinal como anorexígeno não define se o paciente terá melhora nutricional ou benefício em eventos.
