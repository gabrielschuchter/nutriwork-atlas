...
Na prática esportiva, o exercício induz simultaneamente processos catabólicos e anabólicos. Durante a sessão predominam vias produtoras de energia; posteriormente ocorre remodelação e recuperação tecidual.

Na terapia nutricional, compreender o grau de catabolismo auxilia na estimativa das necessidades energéticas e proteicas e na interpretação das limitações da intervenção nutricional isolada.
...
Embora esses mecanismos sejam bem estabelecidos, a magnitude do catabolismo varia amplamente entre indivíduos e conforme a doença subjacente.

## Limitações e controvérsias

É frequente o uso inadequado do termo para descrever qualquer situação de perda muscular. Entretanto, perda de massa magra depende do balanço entre síntese e degradação ao longo do tempo, e não apenas da presença de processos catabólicos.

Também é incorreto considerar o catabolismo como um fenômeno exclusivamente indesejável. Sem ele, não haveria fornecimento adequado de energia durante jejum, exercício ou diversas adaptações fisiológicas.

Outro equívoco comum é atribuir ao [[Cortisol]] isoladamente a perda muscular. Embora participe da regulação do [[Metabolismo|metabolismo]] proteico, sua ação depende do contexto energético, inflamatório e hormonal global.
