...
O conceito aparece frequentemente na discussão de [[Obesidade]], manutenção da perda de peso, recuperação ponderal e planejamento de estratégias de emagrecimento.

Sua relevância clínica decorre da possibilidade de que indivíduos submetidos à perda ponderal sustentada apresentem gasto energético inferior ao esperado, aumentando a dificuldade de manutenção do peso reduzido.

O conceito também é frequentemente utilizado em contextos de [[Disponibilidade Energética]] reduzida e adaptações fisiológicas associadas ao exercício prolongado.
...
Entretanto, a magnitude, persistência e relevância clínica desse fenômeno permanecem variáveis entre estudos.

A evidência mais robusta apoia a existência do fenômeno fisiológico. A magnitude exata do seu impacto sobre recuperação de peso a longo prazo é menos estabelecida.

## Limitações e controvérsias

Grande parte da discussão pública sobre adaptação metabólica extrapola substancialmente os dados disponíveis.
...
A existência da adaptação metabólica é sustentada pela evidência. Sua utilização como explicação dominante para obesidade ou reganho de peso permanece uma inferência mais controversa.
...
Hall KD. Metabolic Adaptations to Weight Loss.

Heymsfield SB, Wadden TA. Mechanisms, Pathophysiology and Management of Obesity.
