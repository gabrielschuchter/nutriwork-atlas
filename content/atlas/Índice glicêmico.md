...
O índice glicêmico pode ajudar a descrever a velocidade relativa da resposta glicêmica de alimentos ricos em carboidrato. Seu uso em planejamento clínico exige considerar a quantidade consumida, pois um alimento com índice menor pode produzir grande exposição quando a porção é grande. A [[Carga glicêmica]] combina a resposta relativa com a quantidade de carboidrato disponível.

Em diabetes, substituições que reduzem a resposta pós-prandial podem melhorar glicemia em alguns estudos. O impacto sobre complicações, eventos cardiovasculares e qualidade de vida precisa ser demonstrado separadamente. A escolha alimentar também deve contemplar fibra, densidade energética, micronutrientes, custo, preferência e tolerância.
