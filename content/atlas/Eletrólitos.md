...
Eletrólitos são substâncias que se dissociam em íons em solução e participam da distribuição de água, do equilíbrio ácido-base, da excitabilidade elétrica e do transporte através de membranas. Sódio, potássio, cloreto, bicarbonato, cálcio, magnésio e fosfato são exemplos fisiologicamente relevantes.

A concentração plasmática é uma medida de distribuição em um compartimento. Ela não equivale diretamente ao conteúdo corporal total do eletrólito.
...
Reposição empírica baseada apenas em sintomas pode falhar porque fadiga, náusea e cãibras têm múltiplas causas. A correção deve considerar método laboratorial, função renal, medicamentos e risco de deslocamento entre compartimentos.

Bebidas esportivas ou soluções comerciais não são intercambiáveis com fluidos usados em hospital. O benefício de adicionar eletrólitos depende da magnitude da perda e da situação clínica, e não da presença de exercício ou diarreia por si só.
...
- Adrogué HJ, Madias NE. Hyponatremia. New England Journal of Medicine. 2000;342:1581-1589. https://doi.org/10.1056/NEJM200005253422107.
